      ...
      <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" onsubmit="return openPopup(event)">
          ...
          <div class="input-box">
            ...
            <input type="text" id="age" name="age" maxlength="2" required
              oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 2);" pattern="[0-9]{1,2}"
          ...
          <div class="popup" id="popup">
            ...
            <button type="button" class="popbtn" onclick="submitForm()">Confirm</button>
            <button type="button" class="popbtn cancel" onclick="closePopup()">Cancel</button>
          </div>
        </form>
      </div>
    </div>
