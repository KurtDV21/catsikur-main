...
<header>
  ...
  <footer class = "footer">
    ...
    // Make an AJAX request to toggle the restriction status
    // After updating the status, toggle the button text and class dynamically
    const button = document.querySelector(`button[data-user-id='${userId}']`);
    if (isRestricted) {
        button.textContent = "Restrict";
        button.classList.remove('restricted');
    } else {
        button.textContent = "Unrestrict";
