...
if (isset($_SESSION['post_added']) && $_SESSION['post_added'] === true) {
  echo "<script>
      document.addEventListener('DOMContentLoaded', function() {
          showPostAddedModal();
      });
  </script>";
  unset($_SESSION['post_added']); // Ensure it's shown only once
}
...
<body>
  ...
  <section id="sample" class="sample">
    <div class="sample-container">
      ...
      <div class="adopting">
        <h3>Adopting</h3>
        <p>Provide a loving home for one of our community cats. Adopting a cat not only helps the animal but also
          creates a bond for life.</p>
        <button>Adopt</button>
      </div>
      ...
      <div class="community">
        <h3>Community</h3>
        <p>Join our community efforts to feed and care for our feline friends. Become a volunteer or contribute in other
          ways.</p>
        <button>Join</button>
      </div>
    </div>
